...
export const NodeList = ({ worldId }: { worldId: number }) => {
  ...
  return (
    <div className="shadow-sharp flex h-fit flex-col items-center gap-2 bg-white px-3 py-4 outline outline-black">
      <div className="peer flex w-full flex-row items-center justify-between gap-4">
      ...
      <form
        ...
        className="hidden items-center gap-2 outline-black peer-has-checked:flex"
      >
        <input
          type="text"
          value={name}
